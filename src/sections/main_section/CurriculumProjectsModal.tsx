      ...
      <Modal.Body>
        ...
        <div className={styles.modal_buttons_div}>
          ...
          <div className={styles.modal_buttons_description_div}>
            ...
            <Button onClick={() => handleClickButtons("#fcc_cur_sec_1")} className='bg-blue-700' variant="primary">Responsive Web Design</Button>
            <hr />
          </div>
          ...
          <div className={styles.modal_buttons_description_div}>
            ...
            <Button onClick={() => handleClickButtons("#fcc_cur_sec_2")} className='bg-gray-600' variant="secondary">Front-end Libraries</Button>
            <hr />
          </div>
          ...
          <div className={styles.modal_buttons_description_div}>
            ...
            <Button onClick={() => handleClickButtons("#fcc_cur_sec_3")} className='bg-green-600' variant="success">APIs and Microservices</Button>
            <hr />
          </div>
          ...
          <div className={styles.modal_buttons_description_div}>
            ...
            <Button onClick={() => handleClickButtons("#fcc_cur_sec_4")} className='bg-yellow-500' variant="warning">Data Visualization</Button>
            <hr />
          </div>

          <div className={styles.modal_buttons_description_div}>
            <p>Focusing on software quality, this certification taught how to create unit tests on server side with <strong>Chai</strong>.</p>
            <Button onClick={() => handleClickButtons("#fcc_cur_sec_5")} className='bg-red-600' variant="danger">Quality Assurance</Button>
            <hr />
          </div>
